  ...
  const features = [
    {
      ...
      description:
        "Distribute your music to over 200+ DSPs (like Spotify, Amazon, iTunes, and more) within 6–10 days and easily collect your earnings.",
      icon: (
    ...
    },
    {
      ...
      description:
        "We craft strategic marketing campaigns customized to your goals and budget — driving real engagement, visibility, and fan growth.",
      icon: (
        <div className="w-12 h-12 flex items-center justify-center">
          <img
            src="/icons/chart.png"
            alt="Tailored Marketing Campaigns"
            className="w-full h-full object-contain"
          />
        </div>
      ),
    ...
    },
    {
      ...
      description:
        "Access in-depth royalty analytics that show you exactly where your income is coming from — from which store, country, and more.",
      icon: (
        <div className="w-12 h-12 flex items-center justify-center">
          <img
            src="/icons/pie.png"
            alt="Analytics & Accounting"
            className="w-full h-full object-contain"
          />
        </div>
      ),
    ...
    },
    {
      ...
      description:
        "As a YouTube Certified Service Provider, we help you monetize your music — even if others have uploaded it — and make sure you get paid fairly.",
      icon: (
        <div className="w-12 h-12 flex items-center justify-center">
          <img
            src="/icons/play.png"
            alt="YouTube MCN Services"
            className="w-full h-full object-contain"
          />
        </div>
      ),
    ...
    },
    {
      ...
      description:
        "From copyright registration to royalty collection and licensing, we handle every aspect of your music publishing with precision and care.",
      icon: (
        <div className="w-12 h-12 flex items-center justify-center">
          <img
            src="/icons/plane.png"
            alt="Music Publishing Support"
            className="w-full h-full object-contain"
          />
        </div>
      ),
    ...
    },
    {
      ...
      description:
        "Once you're part of Streamo, you'll get access to a network of talented artists, opening doors for collaboration and creative growth.",
      icon: (
        <div className="w-12 h-12 flex items-center justify-center">
          <img
            src="/icons/music2.png"
            alt="A&R & Artist Network"
            className="w-full h-full object-contain"
          />
        </div>
      ),
    ...
    },
    {
      ...
      description:
        "Partner with our in-house Marketing & PR Team as you release music — we bring the record label experience directly to you, with none of the hassle.",
      icon: (
        <div className="w-12 h-12 flex items-center justify-center">
          <img
            src="/icons/label.png"
    ...
    },
    {
      ...
      description:
        "Our PR team works closely with top-tier media outlets to boost your brand, tell your story, and build the visibility you deserve.",
      icon: (
        <div className="w-12 h-12 flex items-center justify-center">
          <img
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10 overflow-hidden">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            We're a next-generation music distribution and artist services
            platform, providing all the tools and support you need — with full
            freedom, control, and a reliable partner by your side.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div
                className={`h-full backdrop-blur-sm bg-black/50 p-4 sm:p-4 md:p-5 lg:p-6 flex flex-col ${
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
              ...
              <div className="w-full md:w-2/3 mt-4 md:mt-0">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 text-center md:text-left">
                  Start Your Music Journey Today
                </h3>
                <p className="text-gray-300 mb-4 text-center md:text-left text-sm sm:text-base">
                  Join thousands of independent artists who trust Streamo
                  Digital with their music distribution.
                </p>
